...
diffExpression <- readRDS(proot$find_file(
    config$outputpath, "data", "diff_expr_Stem-TA_wilcox_monocle_Stem-TA_ref_regress-cc_subsets-all_2024-06-18.rds"
))
...
commonFilename <- paste0("gsea_Stem-TA_wilcox_monocle_Stem-TA_ref_regress-cc_subsets-all_", today)
